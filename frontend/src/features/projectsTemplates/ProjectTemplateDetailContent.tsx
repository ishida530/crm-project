    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                    <h2 className="text-xl mb-2"><Badge variant="outline">Todo</Badge></h2>
                    <div className="space-y-2">{renderTasks(TaskStatus.TO_DO)}</div>
                </div>
                <div>
                    <h2 className="text-xl mb-2"><Badge variant="outline">In Progress</Badge></h2>
                    <div className="space-y-2">{renderTasks(TaskStatus.IN_PROGRESS)}</div>
                </div>
                <div>
                    <h2 className="text-xl mb-2"><Badge variant="outline">Complete</Badge></h2>
